...
class RugbyFixturesContentModule implements SportsBotContentModuleInterface
{
    ...
    {
        return 'RUGBY_FIXTURES';
    }

    public function label(): string
    {
        return 'Rugby Fixtures TV';
    }

    public function routeKey(): string
    {
        return TelegramRouteKeys::RUGBY;
    }

    public function buildSummary(): array
    {
        return $this->service->buildSummary('rugby');
    }
    ...
    public function telegramOptions(array $summary): array
    {
        return [
            ...
            'payload' => [
                ...
                'captions_enabled' => (bool) $this->settings->get('rugby_fixture_captions_enabled', false),

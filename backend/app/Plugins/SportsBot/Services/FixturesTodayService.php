...
class FixturesTodayService
{
        ...
        foreach ($leagueIds as $leagueId) {
            ...
            foreach ($rows as $row) {
                ...
                $fixture = [
                    ...
                    'time' => $kickoffAt->format('g:i A'),
                    'date_label' => $kickoffAt->format('l j F Y'),
                    'kickoff_label' => $kickoffAt->format('g:i A T'),
    ...
    {
        if (in_array($sport, ['Football', 'Basketball', 'Baseball', 'American Football', 'Rugby', 'Fights', 'Motorsport', 'Ice Hockey', 'Tennis', 'Cricket', 'Formula 1', 'Golf', 'Boxing'], true)) {

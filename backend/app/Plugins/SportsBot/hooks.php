...
GameHooks::listen('admin.sidebar', function (array $sections): array {
    $sections[] = [
        ...
        'children' => [
            ...
            ['route' => '/sportsbot/uptime', 'label' => 'Uptime Monitor', 'icon' => 'SignalIcon', 'plugin' => 'sportsbot'],
            ['route' => '/sportsbot/monitor-settings', 'label' => 'Monitor Bot', 'icon' => 'Cog6ToothIcon', 'plugin' => 'sportsbot'],

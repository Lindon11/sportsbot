    ...
    'cards' => [
        ...
        'template_registry' => [
            ...
            'routes' => [
                ...
                'USA_SPORTS' => ['template' => 'usa-broadcast-v3', 'theme' => 'usa-broadcast'],
                'FIGHTS' => ['template' => 'fight-poster-v3', 'theme' => 'fight-night'],
                'TV_GUIDE' => ['template' => 'compact-tv-v1', 'theme' => 'limitless-dark'],
                'OTHER_SPORTS' => ['template' => 'stadium-v3', 'theme' => 'limitless-dark'],
            ],
            'topics' => [],
        ],
    ],
